...
public class InvertedIndex{// extends Configured implements Tools{
	...
	public static class ReduceInd
       extends Reducer<Text,Text,Text,Text> {
		...
		public void reduce(Text key, Iterable<Text> values,
	    	...
	    	//in order to be able to apply Collections.frequency later
	
			for (Text value : values) {
				l.add(value.toString());
			}
			HashSet<String> set = new HashSet<String>(l);//hashset disable duplication
			StringBuilder builder = new StringBuilder();
	
			String prefix = "";//initialize the prefix for the first document
			for (String doc : set) {
				builder.append(prefix);
				prefix = ", ";
				builder.append(doc + "#"+Collections.frequency(l,doc));
			}
